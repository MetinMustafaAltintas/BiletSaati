...
{
    /// <inheritdoc />
    public partial class mtn57 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionTickets", x => new { x.TicketID, x.SessionID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionScreens", x => new { x.ScreenID, x.SessionID });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "b515f362-9c3a-486f-b7fd-c96083e87c2c", new DateTime(2024, 7, 30, 14, 27, 10, 772, DateTimeKind.Utc).AddTicks(145), null, null, "Admin", "ADMIN", 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, null, "84b80305-5991-414c-83f3-ababf96f740e", new DateTime(2024, 7, 30, 14, 27, 10, 772, DateTimeKind.Utc).AddTicks(374), null, "metinmustafaaltintas@gmail.com", true, false, null, null, "METINMUSTAFAALTINTAS@GMAIL.COM", "METIN", "AQAAAAIAAYagAAAAEJkpJ2T/QzNsmGJjzJLg4Z2LXnT0dcf8vCS+e02Ln8WfQ8En/bIAb0hfV67bWu0mPw==", null, false, "c9b3ffe0-6ebe-42a5-8aae-27dbb151e834", 1, false, "metin" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId", "CreatedDate", "DeletedDate", "ModifiedDate", "Status" },
                values: new object[] { 1, 1, new DateTime(2024, 7, 30, 14, 27, 10, 862, DateTimeKind.Utc).AddTicks(4000), null, null, 1 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionScreens_SessionID",
                table: "SessionScreens",
                column: "SessionID");

            migrationBuilder.CreateIndex(
                name: "IX_SessionTickets_SessionID",
